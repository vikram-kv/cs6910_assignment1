# the main file of the folder. Contains code to load data, normalize it (and possibly augment train data),
...
def gen_parser():
    ...
    parser.add_argument('-lr','--learning_rate', dest='learning_rate', default=0.0013, type=float, help='Learning rate used to optimize model parameters')
    ...
    parser.add_argument('-a', '--activation', dest='activation_function', default='leakyrelu', choices=['identity', 'sigmoid', 'tanh', 'relu', 'leakyrelu', 'elu', 'swish'], help='Activation function to be used')
