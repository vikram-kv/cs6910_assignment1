...
def gen_parser():
    ...
    parser.add_argument('-a', '--activation', dest='activation', default='elu', choices=['identity', 'sigmoid', 'tanh', 'relu', 'leakyrelu', 'elu'], help='Activation function to be used')
    parser.add_argument('-log', '--log_data', dest='logging', type=int, default=0, help='non-zero for wandb sweeping and logging')
    return parser
...
if __name__ == '__main__':
    ...
    train_X, val_X, train_y, val_y = train_test_split(x_train, y_train, test_size=0.1, shuffle=True, random_state=2)
