...
def gen_parser():
    ...
    parser.add_argument('-e', '--epochs', dest='epochs', default=1, type=int, help='Number of epochs to train neural network')
    parser.add_argument('-b', '--batch_size', dest='batch_size', default=4, type=int, help='Batch size used to train neural network')
    ...
    parser.add_argument('-lr','--learning_rate', dest='lr', default=0.1, type=float, help='Learning rate used to optimize model parameters')
