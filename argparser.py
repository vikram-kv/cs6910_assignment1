...
def gen_parser():
    ...
    parser.add_argument('-o', '--optimizer', dest='opt', default='nag', choices=['sgd', 'momentum', 'nag', 'rmsprop', 'adam', 'nadam'], help='Optimization method to use for training')
    parser.add_argument('-lr','--learning_rate', dest='lr', default=1e-3, type=float, help='Learning rate used to optimize model parameters')
    parser.add_argument('-m', '--momentum',dest='mom', default=0.9, type=float, help='Momentum used by momentum and nag optimizers')
