...
def gen_parser():
    ...
    parser.add_argument('-e', '--epochs', dest='epochs', default=5, type=int, help='Number of epochs to train neural network')
    ...
    parser.add_argument('-lr','--learning_rate', dest='lr', default=0.5*1e-2, type=float, help='Learning rate used to optimize model parameters')
